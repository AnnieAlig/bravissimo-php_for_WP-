...
function create_post_type_levels()
{
    ...
    register_post_type('html5-levels', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'add_new' => __('Add New', 'levels'),
            'add_new_item' => __('Add New HTML5 Blank Custom Post', 'levels'),
            'edit' => __('Edit', 'levels'),
            'edit_item' => __('Edit HTML5 Blank Custom Post', 'levels'),
            'new_item' => __('New HTML5 Blank Custom Post', 'levels'),
            'view' => __('View HTML5 Blank Custom Post', 'levels'),
            'view_item' => __('View HTML5 Blank Custom Post', 'levels'),
            'search_items' => __('Search HTML5 Blank Custom Post', 'levels'),
            'not_found' => __('No HTML5 Blank Custom Posts found', 'levels'),
            'not_found_in_trash' => __('No HTML5 Blank Custom Posts found in Trash', 'levels')
        ),
        'public' => true,
...
function create_post_type_offers()
{
    ...
    register_post_type('html5-offers', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'add_new' => __('Add New', 'offers'),
            'add_new_item' => __('Add New HTML5 Blank Custom Post', 'offers'),
            'edit' => __('Edit', 'offers'),
            'edit_item' => __('Edit HTML5 Blank Custom Post', 'offers'),
            'new_item' => __('New HTML5 Blank Custom Post', 'offers'),
            'view' => __('View HTML5 Blank Custom Post', 'offers'),
            'view_item' => __('View HTML5 Blank Custom Post', 'offers'),
            'search_items' => __('Search HTML5 Blank Custom Post', 'offers'),
            'not_found' => __('No HTML5 Blank Custom Posts found', 'offers'),
            'not_found_in_trash' => __('No HTML5 Blank Custom Posts found in Trash', 'offers')
        ),
        'public' => true,
        'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => true,
...
function wpds_validate_phone_number($result, $tag) {
    $field_name = $tag['type'];
    if ($field_name == 'tel') { // Указываем имя поля для телефонного номера
